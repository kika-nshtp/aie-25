...
@app.post("/quality-flags-from-csv",
    tags=["quality"], summary = "Возвращает полный набор флагов качества из csv-файла",)
async def quality_from_csv(file: UploadFile = File(...) )->dict[str, object]:
    """
    ...
    return dict[str,object](flags = flags_all)
