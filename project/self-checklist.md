...
| 3  | Есть EDA и хотя бы один эксперимент с метриками                          |         `✅`         | `notebooks/emotion_analysis_extended.ipynb`, `report.md`     |
| 4  | Есть baseline и улучшенная модель, есть **сравнение по метрикам**        |         `✅`         | `notebooks/emotion_analysis_extended.ipynb`, `report.md` |
